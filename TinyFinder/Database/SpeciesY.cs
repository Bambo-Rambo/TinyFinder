...
{
    internal class SpeciesY : LocationsXY
    {
        public static List<Location> WildLocationsY()
        {
            ...
            foreach (Location loc in locations)
            {
                switch (loc.Name)
                {
                    ...
                    case "Terminus Cave":
                        ...
                        loc.HordeTable = new ushort[] { 632, 74, 246, };
                    ...
                    case "Route 10":
                        ...
                        loc.HordeTable = new ushort[] { 299, 193, 309, };
                        break;

                    case "Route 11":
                        loc.GrassTable = new ushort[] { 297, 297, 538, 538, 397, 397, 434, 433, 30, 33, 702, 702, };
                        loc.HordeTable = new ushort[] { 32, 434, 396, };
                        break;

                    case "Route 12":
                        loc.GrassTable = new ushort[] { 79, 79, 79, 441, 441, 441, 241, 128, 102, 214, 417, 417, };
                        loc.YellowTable = new ushort[] { 241, 241, 241, 128, 128, 128, 79, 441, 102, 214, 417, 417, };
